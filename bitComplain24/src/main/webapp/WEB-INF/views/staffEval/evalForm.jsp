...
<html>
    ...
    <body style="background:#edf1f8; margin-top:3rem;">
        ...
        <div style="margin-left:31rem; border: 1px solid white; width:937px; background: white">
            ...
            <table style="margin-left:15rem;">                
                ...
                <tr>
                    <td style="font-size:20px; font-weight: bold;">직원 성명 : </td>
                    <td>
                        <select name="staffName" id="interest" style="width:200px; height:40px; padding-left:10px;">
                            <option value="김태희">김태희</option>
                            <option value="고창석">고창석</option>
                            <option value="오달수">오달수</option>
                            <option value="이주빈">이주빈</option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <input type="checkbox" name="q2"> 의견을 무시하고 방치하였다. <br/><br/>
                        <input type="checkbox" name="q3"> 친절한 설명과 안내를 해주었다. <br/><br/>
                        <input type="checkbox" name="q4"> 불친절한 설명과 제대로 된 안내가 없었다. <br/><br/>
                        <input type="checkbox" name="q5"> 자신의 역할에 적극적인 모습을 보였다. <br/><br/>
                        <input type="checkbox" name="q6"> 자신의 역할에 적극적이지 못한 모습을 보였다. <br/><br/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <input type="submit" onclick="location.href = '${pageContext.request.contextPath }/staffEval/eval'" value="평가 제출하기" style="width:400px; height:40px; background:#4d87ef; color:whitesmoke;font-family: 'Noto Sans KR', sans-serif;font-size:20px;">
                    </td>
                </tr>
            </table>
        </div>
